...
articles = [
  {
    ...
    title: '關於我們',
    content: '<p>社會民主黨是由一群長期關心台灣各個議題的公民所組成。 和你一樣，我們對既有政治的不滿已經很久了。 現在，我們決定自己捲起袖子，動手打造台灣的新政治。
</p>
<ul class="list-icons">
  <li>我們想要的新政治，是關心價值與政策的政治。</li>
  <li>我們想要的新政治，是認真討論公共事務，
    <br />
    <span>而不是完全仰賴人情網絡的政治。</span></li>
  <li>我們想要的新政治，是永遠站在受薪階級與弱勢這一邊，
    <br />
    <span>而不是倒向財團與優勢者的政治。</span></li>
  <li>我們想要的新政治，是人人都可以參與的政治，
    <br />
    <span>而不是富二代或政二代才能出頭的政治。</span></li>
</ul>
<p>
  因此，這個全新的政黨，將用具體的政策，團結中產者、受薪者、弱勢者、和無力者， 用新世代選民的行動與選票，打破兩黨寡占的政治、打破財團壟斷的經濟，以及創建平等、尊重與多元的社會。
</p>
<p>如果你認同這樣的想法，希望這樣的一股力量能夠長大，我們一起打拼吧！</p>
'
  }, {
    id: 2,
    kind: 'system',
